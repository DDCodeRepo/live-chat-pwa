...
import { RoleBasedGuard } from "src/services/user-role-service/role-gaurd-hoc";
import { privilageValueEnum } from "src/services/user-role-service/privilage-values";
...
const reduceChildRoutes = ({
  ...
  if (item.children) {
    ...
    acc.push(
      <RoleBasedGuard codeValue={privilageValueEnum['TEST']}>
        <NavItem
          active={partialMatch}
          depth={depth}
          icon={item.icon}
